...
import com.hfzq.xfn.framework.commlib.CommUtilsExtKt;
...
public class FileUtils {
    ...
    public static List<Entry> loadEntriesFromFile(String path) {
        File sdcard = CommUtilsExtKt.getAPPLICATION().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS);
        ...
        // File sdcard = Rc.getApplication().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS);
        //
        // // Get the text file
        // File file = new File(sdcard, path);
        //
