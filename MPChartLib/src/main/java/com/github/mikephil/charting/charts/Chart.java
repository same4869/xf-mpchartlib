...
//            c.drawText(mDescription.getText(), x, y, mDescPaint);
    ...
    public boolean saveToPath(String title, String pathOnSD) {
        ...
        try {
            stream = new FileOutputStream(getContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES).getPath()
                    + pathOnSD + "/" + title
                    + ".png");
    ...
    public boolean saveToGallery(String fileName, String subFolderPath, String fileDescription, Bitmap.CompressFormat
        ...
        File extBaseDir = getContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES);
